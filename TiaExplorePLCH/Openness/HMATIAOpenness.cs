...
/// <summary>
/// 
/// Créateur : Youssef EL BAZI Siemens DI CS France
/// Date de création : 10/02/2023
///
/// Projet : Interface de programmation pour acces à TIA Portal V17 via Openness
/// 
/// Définition : L'espace OpennessV16 contient la classe de gestion de l'acces à TIA Portal V17
/// 
///     Liste des classes : 
///                         HMATIAOpenness_V16    :    Objet interface Openness TIA Portal V17
/// 
/// 
/// Modifications :
/// 
...
{
    /// <summary>
    /// Classe de gestion de l'interface Openness TIA Portal 
    /// </summary>
    public class HMATIAOpenness_V16
    {
        ...
        public HMATIAOpenness_V16(bool bOpenTIAPortal, ref string sError)
        {
            ...
            try
            {
                ...
                {
                    case true: m_oTiaPortal = new TiaPortal(TiaPortalMode.WithUserInterface);
                        break;
                    case false: m_oTiaPortal = new TiaPortal(TiaPortalMode.WithoutUserInterface);
...
*/
    ...
    /// <summary>
    /// Classe de récupération des instances de Tia Portal en cours
    /// </summary>
