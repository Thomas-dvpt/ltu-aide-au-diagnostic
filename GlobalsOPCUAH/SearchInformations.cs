...
namespace GlobalsOPCUAH
{
    ...
    /// </summary>
    public class PLC_H_ProjectDefinitions
    {
        #region constantes
        ...
        /// </summary>
        public PLC_H_ProjectDefinitions()
        { 
        }
        ...
        /// </summary>
        public PLC_H_ProjectDefinitions(string sOpennessLibraryPath, string sUserName, string sCryptPasswordUser)
        {
